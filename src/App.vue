...
@media (max-width: 1023px) {
  /* Reorganiza el orden de las secciones en pantallas medianas */
  .content-area {
    flex-direction: column;
    height: auto;
    min-height: 100%;
...
@media (max-width: 599px) {
  ...
  .page-container {
    padding-bottom: 80px; /* deja espacio para el botón de pago fijo */
  }
  ...
  .cart-items-container.scrollable::-webkit-scrollbar {
    width: 6px;
  }

  .cart-items-container.scrollable::-webkit-scrollbar-thumb {
  ...
  /* Notificaciones en pantallas pequeñas */
  .notificacion-custom {
    top: 65px;
    min-width: 95%;
    max-width: 95%;
...
/* 📲 Extra: pantallas muy pequeñas (menos de 400px) */
